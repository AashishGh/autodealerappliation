...
--
-- Dumping data for table `warehouse_sale_record_dim`
--

LOCK TABLES `warehouse_sale_record_dim` WRITE;
/*!40000 ALTER TABLE `warehouse_sale_record_dim` DISABLE KEYS */;
/*!40000 ALTER TABLE `warehouse_sale_record_dim` ENABLE KEYS */;
UNLOCK TABLES;
